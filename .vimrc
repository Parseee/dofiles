...
nnoremap cpf i#include <iostream><Esc>o#include <vector><Esc>o#include <cmath><Esc>o#include <algorithm><Esc>o#include <deque><Esc>o#include <ios><Esc>o<Esc>o#define ll long long<Esc>o#define pi std::pair <int, int><Esc>o#define INF 1e9<Esc>o#define SZ 1e5<Esc>o<Esc>o<CR>int main(){<Esc>ostd::ios_base::sync_with_stdio(0);<Esc>ostd::cin.tie(0);<Esc>ostd::cout.tie(0);<Esc>o<Esc>o}<Esc>ki
